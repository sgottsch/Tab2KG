...
public final class DateParserUtils {
    ...
    /**
     * Parse the specified String into MyDateTime instance, it will convert different TimeZone into system's default zone.
     *
     * @param str Datetime string like '2019-10-01 00:10:20 +0800'
     * @author ANONYMIZED
     * @return Parsed datetime as MyDateTime
     */
    public static synchronized MyDateTime parseMyDateTime(String str) {
        return dateParser.parseMyDateTime(str);
    }
