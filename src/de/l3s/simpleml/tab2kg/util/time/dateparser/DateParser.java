...
/**
 * DateParser represents an unique parser context, it shouldn't be used
 * concurrently.
 * <p>
 * In most cases, datetime's parsing should be very fast, so you can use
 * {@link DateParserUtils} directly.
 * <p>
 * If need use it in multiple threads, you can create your own parser by
 * {@link DateParserBuilder}.
 *
 * @author sulin
...
public final class DateParser {
	...
	/**
	 * Create an new DateParserBuilder which could be used for initialize
	 * DateParser.
	 *
	...
	/**
	 * If parser cannot distinguish the dd/mm and mm/dd, preferMonthFirst will help
	 * it determine.
	 *
	 ...
	 */
	public MyDateTime parseMyDateTime(String str) {
		this.dt.reset();
		this.input = str;
		this.hasDate = false;
		this.hasTime = false;
		...
		return new MyDateTime(date, this.hasDate, this.hasTime);
	}
	...
	/**
	 * Parse an subsequence which represent dd/mm or mm/dd, it should be more smart
	...
	/**
	 * Parse an subsequence which represent the offset of timezone, like '+0800',
	 * '+08', '+8:00', '+08:00' etc
	 */
	...
	/**
	 * Parse an subsequence which suffix second, like '.2000', '.3186369',
	 * '.257000000' etc It should be treated as ms/us/ns.
	 */
