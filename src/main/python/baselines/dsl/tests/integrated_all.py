...
# ATT NAME: LBL_TEST y
# TEXT JACCARD: JACCARD_TEST y
# TF-IDF COSINE: TF_IDF_TEST y
# NUM JACCARD: COVER_TEST y
# NUM KS: KS_TEST
# MW HISTOGRAM: MW_TEST

# HERE
feature_list = [COVER_TEST, JACCARD_TEST, TF_IDF_TEST, MW_NUM_TEST]

# profiles
#feature_list = [COVER_TEST, MW_NUM_TEST, CHAR_LEN_TEST, STR_LEN_TEST]
