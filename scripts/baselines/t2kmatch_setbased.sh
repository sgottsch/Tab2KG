...
WEB="/storage~/tab2kg/data/semtab_easy/t2kmatch/d/tables"
...
GS_CLS="~/tab2kg/data/semtab_easy/t2kmatch/d/gs_class.csv"
GS_PROP="~/tab2kg/data/semtab_easy/t2kmatch/d/gs_property.csv"
#GS_INST="/storage~/www21/data/semtab_easy/t2kmatch/gs_instance.csv"

# output location
RES="~/tab2kg/data/semtab_easy/t2kmatch/d/output/"
